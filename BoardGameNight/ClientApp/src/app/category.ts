...
export class Category {
    ...
    static getCategoryNameById(id:string):string {
        return this.categories.find(c => c.id == id)!.name;
    }

    static getUrlById(id:string):string {
        return this.categories.find(c => c.id == id)!.url;
    }

    static getIdByName(name:string):string {
        return this.categories.find(c => c.name == name)!.id;
    }

    static getObjectByName(name:string):iCategory {
        return this.categories.find(c => c.name == name)!;
    }
    static getObjectById(id:string):iCategory {
    ...
    static categories: iCategory[] = [
        ...
        },
        {
            id: "Rmn5g0nYVL",
            name: "Words",
            url: "https://www.boardgameatlas.com/category/Rmn5g0nYVL/words"
        },
        {
            id: "wTLJSVEbm6",
            name: "World War I",
